 ...
 */
 ...
 public enum TokenType implements Serializable {
    ...
    * This type is associated with a token that represents a byte size value with a unit,
    ...
    * This type is associated with a token that represents a time duration value with a unit,
    * such as "150ms", "2.5s", or "1h".
    */
   TIME_DURATION
 }